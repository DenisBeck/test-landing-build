(() => {
    ...
    function initSliders() {
        if (document.querySelector(".stages__slider")) new swiper_core_Swiper(".stages__slider", {
        ...
        if (document.querySelector(".participants__slider")) new swiper_core_Swiper(".participants__slider", {
